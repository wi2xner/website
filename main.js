...
function toggleButton() {
  ...
  loginButton.addEventListener("click", Connected);
}
...
async function Connected() {
  ...
  loginButton.removeEventListener("click", Connected);
  setTimeout(() => {
    loginButton.addEventListener("click", Disconnect);
  }, 200);
}
...
function Disconnect() {
  ...
  loginButton.removeEventListener("click", Disconnect);
  setTimeout(() => {
    loginButton.addEventListener("click", Connected);
  }, 200);
}
